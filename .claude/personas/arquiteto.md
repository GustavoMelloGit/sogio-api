...
| `StayImportedEvent`              | Estadia gravada por `ImportStaysUseCase` (importação em massa)                   | Lançamento de receita no Finance (`RecordRevenueOnStayImported`) — **sem** provisionar fechadura |
