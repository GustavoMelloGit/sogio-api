...
export function makeMcpRequestHandler(
  ...
  const tools: McpToolDefinition<z.ZodRawShape>[] = [
    ...
    dependencies.notificationDi.makeMarkAllNotificationsReadTool(),
    ...
    dependencies.propertyDi.makeListExternalBookingSourcesTool(),
    dependencies.propertyDi.makeGetExternalBookingSourceTool(),
    dependencies.propertyDi.makeUpdateExternalBookingSourceTool(),
    dependencies.propertyDi.makeDeleteExternalBookingSourceTool(),
