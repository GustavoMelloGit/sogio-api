...
const recordInputSchema = stayImportRecordSchema.extend({
  ...
  check_in: stayImportRecordSchema.shape.check_in.describe(
  ...
  check_out: stayImportRecordSchema.shape.check_out.describe(
  ...
  guests: stayImportRecordSchema.shape.guests.describe(
    "Number of guests staying."
  ),
  price: stayImportRecordSchema.shape.price.describe(
  ...
  tenant_sex: stayImportRecordSchema.shape.tenant_sex.describe("Guest's sex."),
  entrance_code: stayImportRecordSchema.shape.entrance_code.describe(
    "Door lock entrance code. Generated automatically when omitted."
  ),
});
    ...
    for (const record of records) {
      ...
      yield {
        ...
        values: {
          ...
          check_in: record.check_in.toString(),
          check_out: record.check_out.toString(),
